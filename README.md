...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/neo4j-python-driver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/neo4j-python-driver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add neo4j-python-driver
# for installing globally
pixi global install neo4j-python-driver
```
...
It is possible to list all of the versions of `neo4j-python-driver` available on your platform:
...
```
pixi search neo4j-python-driver --channel conda-forge
```
